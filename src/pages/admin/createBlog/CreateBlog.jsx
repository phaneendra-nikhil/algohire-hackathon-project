...
function CreateBlog() {
    ...
    const uploadImage = () => {
        ...
        uploadBytes(imageRef, thumbnail).then((snapshot) => {
            getDownloadURL(snapshot.ref).then((url) => {
                const productRef = collection(fireDb, "MiniBlog")
                try {
                    addDoc(productRef, {
                        blogs,
                        thumbnail: url,
    ...
    return (
        <div className=' container shadow-lg shadow-gray-400 mx-auto max-w-5xl m-10'>
            <div className="p-5" style={{
                ...
                <div className="mb-3">
                    ...
                    <input
                        ...
                        className="placeholder-black w-full rounded-md p-3"
                        style={{
                            background: mode === 'dark'
                                ? '#dcdde1'
                                : '#fff'
                ...
                {/* Five Submit Button  */}
                <Button className=" w-full mt-5 mb-3 p-2.5 text-xl"
                    onClick={addPost}
                    style={{
                        background: mode === 'dark'
                            ? '#252525'
                ...
                {/* Six Preview Section  */}
                {/* <div className="">
                    <h1 className="text-center mb-3 text-xl">Preview</h1>
